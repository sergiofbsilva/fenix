...
public class PhdSchoolRegistrationDeclarationDocument extends FenixReport {
    ...
    private String getRegistrationStateLabel() {
        ...
        return gender == Gender.MALE ? BundleUtil.getString(Bundle.PHD,
                "label.phd.schoolRegistrationDeclaration.registered.male") : BundleUtil.getString(Bundle.PHD,
                        "label.phd.schoolRegistrationDeclaration.registered.female");
    }
