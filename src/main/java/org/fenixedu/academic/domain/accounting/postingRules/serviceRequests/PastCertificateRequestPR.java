...
import org.fenixedu.academic.domain.accounting.events.serviceRequests.PastCertificateRequestEvent;
...
public class PastCertificateRequestPR extends PastCertificateRequestPR_Base {

    protected PastCertificateRequestPR() {
        super();
    }

    public PastCertificateRequestPR(final EntryType entryType, final EventType eventType, final DateTime startDate,
            final DateTime endDate, final ServiceAgreementTemplate serviceAgreementTemplate) {
