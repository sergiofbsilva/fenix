...
public class InstallmentPaymentCode extends InstallmentPaymentCode_Base {
    ...
    public static InstallmentPaymentCode create(final PaymentCodeType paymentCodeType, final YearMonthDay startDate,
        ...
        return PaymentCode.canGenerateNewCode(InstallmentPaymentCode.class, paymentCodeType,
                student.getPerson()) ? new InstallmentPaymentCode(paymentCodeType, startDate, endDate, event, installment,
                        minAmount, maxAmount, student) : findAndReuseExistingCode(paymentCodeType, startDate, endDate, event,
                                minAmount, maxAmount, student, installment);
