...
public class PastAdministrativeOfficeFeeAndInsurancePR extends PastAdministrativeOfficeFeeAndInsurancePR_Base {
    ...
    public List<EntryDTO> calculateEntries(Event event, DateTime when) {
        ...
        return Collections.singletonList(
                new EntryDTO(getEntryType(), event, totalAmountToPay, event.getPayedAmount(), event.calculateAmountToPay(when),
                        event.getDescriptionForEntryType(getEntryType()), event.calculateAmountToPay(when)));
    }
