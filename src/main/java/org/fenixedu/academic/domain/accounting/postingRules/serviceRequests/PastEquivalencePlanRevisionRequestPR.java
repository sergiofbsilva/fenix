...
import org.fenixedu.academic.domain.accounting.events.serviceRequests.PastEquivalencePlanRevisionRequestEvent;
...
public class PastEquivalencePlanRevisionRequestPR extends PastEquivalencePlanRevisionRequestPR_Base {

    protected PastEquivalencePlanRevisionRequestPR() {
        super();
    }

    public PastEquivalencePlanRevisionRequestPR(final DateTime startDate, final DateTime endDate,
            final ServiceAgreementTemplate serviceAgreementTemplate) {
        super.init(EntryType.REVISION_EQUIVALENCE_PLAN_REQUEST_FEE, EventType.PAST_REVISION_EQUIVALENCE_PLAN_REQUEST, startDate,
