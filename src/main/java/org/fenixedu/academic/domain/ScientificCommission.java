...
public class ScientificCommission extends ScientificCommission_Base {
    ...
    public ScientificCommission(ExecutionDegree executionDegree, Person person) {
        ...
        ScientificCommissionLog.createLog(this.getExecutionDegree().getDegree(), this.getExecutionDegree().getExecutionYear(),
                Bundle.MESSAGING, "log.degree.scientificcomission.addmember", this.getPerson().getPresentationName(),
    ...
    public void delete() {
        ScientificCommissionLog.createLog(getExecutionDegree().getDegree(), getExecutionDegree().getExecutionYear(),
                Bundle.MESSAGING, "log.degree.scientificcomission.removemember", this.getPerson().getName(),
                this.getPerson().getUsername(), this.getExecutionDegree().getDegree().getPresentationName());
        setPerson(null);
    ...
    public void logEditMember() {
        ScientificCommissionLog.createLog(this.getExecutionDegree().getDegree(), this.getExecutionDegree().getExecutionYear(),
                Bundle.MESSAGING, "log.degree.scientificcomission.editmember", this.getPerson().getPresentationName(),
                this.getExecutionDegree().getDegree().getPresentationName());
    }
