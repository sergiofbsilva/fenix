...
public class Externalization {
    ...
    private static void fillBibliographicReferences(List<BibliographicReference> refs, final String source) {
        ...
        refs.add(new BibliographicReference(source.substring(0, indexOfSep1),
                ...
                source.substring(indexOfSep5 + ELEMENT_SEPARATOR.length(), indexOfSep6)
                        .equals("null") ? BibliographicReferenceType.MAIN : BibliographicReferenceType
                                .valueOf(source.substring(indexOfSep5 + ELEMENT_SEPARATOR.length(), indexOfSep6)),
