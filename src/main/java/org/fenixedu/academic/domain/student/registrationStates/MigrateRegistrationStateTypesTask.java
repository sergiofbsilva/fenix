...
//
//    private RegistrationStateType canceled;
//    private RegistrationStateType concluded;
//    private RegistrationStateType externalAbandon;
//    private RegistrationStateType flunked;
//    private RegistrationStateType inactive;
//    private RegistrationStateType internalAbandon;
//    private RegistrationStateType interrupted;
//    private RegistrationStateType mobility;
//    private RegistrationStateType registered;
//    private RegistrationStateType schoolPartConcluded;
//    private RegistrationStateType studyPlanConcluded;
//    private RegistrationStateType transited;
//    private RegistrationStateType transition;
...
//        canceled = new RegistrationStateType("CANCELED", new LocalizedString(), new LocalizedString(), null, null, null);
//        concluded = new RegistrationStateType("CONCLUDED", new LocalizedString(), new LocalizedString(), null, null, null);
//        externalAbandon = new RegistrationStateType("EXTERNAL_ABANDON", new LocalizedString(), new LocalizedString(), null, null, null);
//        flunked = new RegistrationStateType("FLUNKED", new LocalizedString(), new LocalizedString(), null, null, null);
//        inactive = new RegistrationStateType("INACTIVE", new LocalizedString(), new LocalizedString(), null, null, null);
//        internalAbandon = new RegistrationStateType("INTERNAL_ABANDON", new LocalizedString(), new LocalizedString(), null, null, null);
//        interrupted = new RegistrationStateType("INTERRUPTED", new LocalizedString(), new LocalizedString(), null, null, null);
//        mobility = new RegistrationStateType("MOBILITY", new LocalizedString(), new LocalizedString(), null, null, null);
//        registered = new RegistrationStateType("REGISTERED", new LocalizedString(), new LocalizedString(), null, null, null);
//        schoolPartConcluded = new RegistrationStateType("SCHOOLPARTCONCLUDED", new LocalizedString(), new LocalizedString(), null, null, null);
//        studyPlanConcluded = new RegistrationStateType("STUDYPLANCONCLUDED", new LocalizedString(), new LocalizedString(), null, null, null);
//        transited = new RegistrationStateType("TRANSITED", new LocalizedString(), new LocalizedString(), null, null, null);
//        transition = new RegistrationStateType("TRANSITION", new LocalizedString(), new LocalizedString(), null, null, null);
//
