...
public class ProgramConclusionProcess extends ProgramConclusionProcess_Base {
    ...
    protected void addSpecificVersionInfo() {
        ...
        if (getGroup().getEnrolmentsSet().contains(dissertationEnrolment)) {
    ...
    private Enrolment getDissertationEnrolment() {
        ...
        return Stream.concat(enrolments, dismissals).sorted(Enrolment.COMPARATOR_BY_EXECUTION_PERIOD_AND_ID.reversed())
