...
public class SearchDegreeStudentsGroup implements Serializable {
    ...
    public boolean matchesSelectCriteria(final StudentCurricularPlan studentCurricularPlan) {
        ...
        if (lastRegistrationState == null || !lastRegistrationState.getStateType().equals(registrationStateType)) {
            return false;
        }
    ...
    public String serialize() {
        ...
        parts.add(getSortBy());
        parts.add(getRegistrationStateType() != null ? getRegistrationStateType().getExternalId() : "ND");
